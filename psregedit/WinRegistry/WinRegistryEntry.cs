namespace PSRegedit
{
    ...
    {
        #region Registry Fields & Properties
        ...
        public RegistryHive Hive
        {
            ...
            {
                privateHive =
                    !Enum.IsDefined(typeof(RegistryHive), value) || value == RegistryHive.CurrentConfig
        ...
        #region Additional Fields & Properties
        ...
        /// This check is faster as it only verifies if a value was read (set in registry).
        /// </summary>
        ...
        /// <summary>
        /// Sets up validation using an array of allowed long integer values.
        /// </summary>
        /// <param name="allowedValues">The array of allowed long integer values.</param>
        ...
        /// The key is considered write-ready if all of the following conditions are met:
        /// - The hive is set
        ...
        public WinRegistryEntry<T> Write()
        {
            ...
            {
                value = Value?.ToString() ?? throw new InvalidOperationException("Unable to write registry key. Value must not be null.");
            }
        ...
        /// <summary>
        /// Logs an info message to the standard output stream.
        /// </summary>
        ...
        /// <exception cref="ArgumentException">Thrown when an unknown or unsupported RegistryValueKind value is provided.</exception>
        /// <exception cref="ArgumentException">Thrown when Value type <typeparamref name="T"/> is not supported.</exception>
        ...
        /// <summary>
        /// Determines whether the registry hive has a valid, non-zero value assigned.
        /// </summary>
        /// <returns><c>true</c> if the hive is a valid non-zero value; otherwise, <c>false</c>.</returns>
