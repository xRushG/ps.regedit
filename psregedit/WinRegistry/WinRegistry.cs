namespace PSRegedit
{
    ...
    public class WinRegistry : IWinRegistry, IWinRegistryRead
    {
        ...
        public string GetValue(RegistryHive Hive, string Path, string Name)
        {
            ...
            // Ensure name is null when null or empty to get the default value
        ...
        /// <summary>
        /// Retrieves the bool value from the specified REG_SZ or REG_DWORD registry key.
        /// </summary>
        /// <param name="Hive">The registry hive.</param>
        /// <param name="Path">The registry key path.</param>
        ...
        /// <summary>
        /// Retrieves the integer value from the specified REG_DWORD registry key.
        /// </summary>
        /// <param name="Hive">The registry hive.</param>
        /// <param name="Path">The registry key path.</param>
        /// <param name="Name">The name of the value.</param>
        ...
        {
            if (!Enum.IsDefined(typeof(RegistryHive), Hive) || Hive == RegistryHive.CurrentConfig)
        ...
        /// <exception cref="ArgumentException">Thrown when the RegistryValueKind is Unknown or None.</exception>
